  ...
  getActivityTabFullData(activityTab: ActivityTab) {
    switch (activityTab) {
      case ActivityTab.CHAT:
        return {id: 1, name: "Chat", link: ServerLinks.CHATS_REQUEST}
      case ActivityTab.ROOMS:
        return {id: 2, name: "Rooms", link: ServerLinks.ROOMS_REQUEST}
      case ActivityTab.PROFILE:
        return {id: 3, name: "Profile", link: ServerLinks.USER_REQUEST}
      case ActivityTab.SEARCH:
        return {id: 4, name: "Search", link: ServerLinks.SEARCH_REQUEST}
      case ActivityTab.SETTINGS:
        return {id: 5, name: "Settings", link: ServerLinks.USER_REQUEST}
    }
  }
}
